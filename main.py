...
def initializer():
    ...
    # Database backup in case of corruption or data-loss:
    db.back_up()
    ...
    # Creating VIEW of items in stock
...
def user_interaction(table, database_class, columns_in_table, our_client, our_material):
    insert_values = [our_material.item_code, dt.datetime.utcnow(), our_client.name, our_client.amount,
